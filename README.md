...
- `gh`/`git` 环境准备、权限边界、Environment Secrets/Variables 和 Telegram 接线；
...
部署与平台配置见 [`docs/operations.md`](docs/operations.md)，凭据见 [`docs/credentials.md`](docs/credentials.md)，分阶段目标见 [`docs/roadmap.md`](docs/roadmap.md)。
